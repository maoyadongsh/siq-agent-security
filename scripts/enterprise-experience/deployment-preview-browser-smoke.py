...
def main():
    ...
    checks = {}
    with tempfile.TemporaryDirectory(prefix='siq-preview-e148-') as raw:
        root = Path(raw)
        ...
        with (root / 'server.log').open('w') as log:
            ...
            try:
                ...
                changes = {}
                for key in ('normal', 'lost', 'empty', 'cancel', 'stale'):
    ...
    (args.out_dir / 'result.json').write_text(json.dumps({'schema_version': 'enterprise-deployment-preview-smoke/v1',
