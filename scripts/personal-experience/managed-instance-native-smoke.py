...
Uses the product managed installation API and public native enable CLI.
...
class Harness(fixture.Harness):
    ...
    def withdraw_runtime_authority(self):
        ...
        return {"method": "identity_revocation", "check": "revoked_identity_blocks_new_native_session"}
    ...
    def public_cli(self):
        ...
        try:
            ...
            withdrawal = self.withdraw_runtime_authority()
            revoked = True
            received.clear()
            ...
            fixture.require(len(self.receipts()) == signed_count, "revoked credential produced authorized receipts")
            ...
            return {
                "schema_version": "personal-managed-instance-native-smoke/v1",
                ...
                "authority_withdrawal": withdrawal,
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="siq-managed-instance-native-") as temporary:
        root = Path(temporary)
