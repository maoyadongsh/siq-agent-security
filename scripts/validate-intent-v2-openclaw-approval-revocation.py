...
class ApprovalHarness(native.OpenClawHarness):
    ...
    def run(self):
                ...
                for case in cases:
                    ...
                    if case["local"] is True:
                        ...
                        if case.get("revoke_during_platform_wait"):
                            ...
                            require(
                                status["status"] == "denied" and status["reason_code"] == "hold_authority_changed",
                    ...
                    require(
                        len(reservations) == int(result["executed"]) and len(observations) == int(result["executed"]),
                    ...
                    outcomes.append(
                        {
                            **result,
                            ...
                            "grant_revoked_before_platform_allow": bool(case.get("revoke_during_platform_wait")),
        ...
        return {
            "schema": "intent-v2-openclaw-approval-revocation-validation/v2",
            ...
            "limitations": [
                ...
                "execution uses a current-authority reservation and observation binds its signed receipt",
                "reservation response loss remains uncertain and requires explicit reconciliation",
