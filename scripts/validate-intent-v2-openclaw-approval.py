...
class ApprovalHarness(native.OpenClawHarness):
    ...
    def run(self):
        ...
        cases = [
            {"id": "platform-deny", "platform": "deny", "local": None},
        ...
        command = [
            ...
            str(ROOT / "scripts/openclaw-approval-worker.mjs"),
            str(spec),
        ]
        ...
        return {
            "schema": "intent-v2-openclaw-approval-validation/v1",
            ...
            "sources": {
                ...
                for path in [
                    Path(__file__),
                    ROOT / "scripts/openclaw-approval-worker.mjs",
