...
The installed OpenClaw and shipping SIQ adapter remain unchanged. Native callback fault cases and a positive control must pass.
"""
...
def main():
    ...
    class FaultHarness(PatchedAdapter, faults.ApprovalHarness):
        pass
    ...
    with tempfile.TemporaryDirectory(prefix="siq-openclaw-recheck-patch-") as tmp:
        ...
        result = {
            "schema": "openclaw-approval-checkpoint-fault-patch-validation/v1",
