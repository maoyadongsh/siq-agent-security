...
- 冻结时间（UTC）：2026-09-17T09:21:05Z（本批新候选，测量前）
- 候选：`siq-v6-f04-r4`（本地 dirty 集成候选，非发行制品）
- 候选二进制 SHA256：`c8048691276590a064b5314837e35c80a2e8fba48471f1bf12c434f6b9ae9853`
- 源绑定（本地 dirty 差异清单，非干净发行源）：`655486599a9c2bab3847521139551078061541c0a1e057b3f3c93f2edae7fcc7`
...
- 专属沙箱：`siq-v6-f05-171950`（本批所有）
- 证据目录：`docs/evidence/personal-experience/v6-f05-20260917-171950/`
...
| 场景 | 旧候选基线 | 理由 |
| --- | --- | --- |
| S1 `doctor_readback` | **not_measured** | 基线为本集成树基点 `9b8c09af…`；此轮只对 r4 候选进行绝对预算测量，未按相同协议独占重测基点。既有 GLM d06 二进制不是基点，不能冒充它。 |
