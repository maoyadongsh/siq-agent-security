...
- 生成：2026-09-14T12:52:30.744545+00:00
- 候选二进制：`/tmp/siq-final-candidate-20260914/siq-agent-security`（sha256 `f4b5c23cfff4f89608b1e113b36858c2938d6f8e06630b6e9031c7665c77420c`，来源：explicit --binary）
- 仓库：`b303c6f92392f3a44c306d81ad7323c6291ef4f2`（工作树含未提交改动路径 109 条，即本批次 N05/R01 实现）
...
| 20-serve-a-start | serve start on 127.0.0.1:35077 (mode=block) + admin pairing | cli+http | pass |  |
...
| 50-serve-b-start | serve start on 127.0.0.1:48701 (mode=block) + admin pairing | cli+http | pass |  |
...
| 62-serve-c-start | serve start on 127.0.0.1:60207 (mode=block) + admin pairing | cli+http | pass |  |
...
| 72-serve-d-start | serve start on 127.0.0.1:44745 (mode=block) + admin pairing | cli+http | pass |  |
