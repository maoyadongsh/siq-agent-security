...
- 生成：2026-09-14T12:41:47.190497+00:00
- 候选二进制：`/tmp/siq-final-candidate-20260914/siq-agent-security`（sha256 `10dedfb776d736c838593b28d24cac77e06eb2788615a74cd4c5f3ae9f46d617`，来源：explicit --binary）
- 仓库：`b303c6f92392f3a44c306d81ad7323c6291ef4f2`（工作树含未提交改动路径 104 条，即本批次 N05/R01 实现）
...
| 20-serve-a-start | serve start on 127.0.0.1:33207 (mode=block) + admin pairing | cli+http | pass |  |
...
| 50-serve-b-start | serve start on 127.0.0.1:52009 (mode=block) + admin pairing | cli+http | pass |  |
...
| 62-serve-c-start | serve start on 127.0.0.1:54305 (mode=block) + admin pairing | cli+http | pass |  |
...
| 72-serve-d-start | serve start on 127.0.0.1:53781 (mode=block) + admin pairing | cli+http | pass |  |
