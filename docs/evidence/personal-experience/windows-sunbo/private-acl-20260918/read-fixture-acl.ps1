...
if ($rootFull -notlike '*\private-acl-daemon-r6') { throw 'Unexpected fixture root' }
...
throw 'Only read/audit modes are supported; mutation belongs to the isolated Python fixture.'
