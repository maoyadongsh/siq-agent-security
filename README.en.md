...
| OpenClaw / Hermes / WorkBuddy | Linux delivery scope is OpenClaw and Hermes; selected real host paths have evidence | WorkBuddy is in scope only on macOS/Windows; WorkBuddy requires its own desktop validation |
