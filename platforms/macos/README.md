...
当前宿主范围为 OpenClaw、Hermes、WorkBuddy。0.4.0 正式包提供 arm64 程序，完成固定源码构建、项目清单验签与 pin 核对；本版尚未完成 macOS 原生安装、升级/回滚和完整同候选宿主验收，也没有以项目签名替代 Apple 签名或公证。交叉构建和 Linux 结果不能作为 macOS 原生通过。
